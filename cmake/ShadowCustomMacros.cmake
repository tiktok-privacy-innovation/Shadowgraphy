...
macro(shadow_combine_archives target dependency)
    if(MSVC)
...
macro(shadow_fetch_thirdparty_content content_file)
    set(SHADOW_FETCHCONTENT_BASE_DIR_OLD ${FETCHCONTENT_BASE_DIR})
    set(FETCHCONTENT_BASE_DIR ${SHADOW_THIRDPARTY_DIR} CACHE STRING "" FORCE)
    include(${content_file})
    set(FETCHCONTENT_BASE_DIR ${SHADOW_FETCHCONTENT_BASE_DIR_OLD} CACHE STRING "" FORCE)
    unset(SHADOW_FETCHCONTENT_BASE_DIR_OLD)
endmacro()
